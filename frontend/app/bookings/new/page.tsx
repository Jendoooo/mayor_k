...
function BookingContent() {
    ...
    const fetchAvailability = async () => {
        setLoading(true);
        try {
            // Using the newly implemented date-range logic
            const availableRooms = await api.getAvailableRooms(checkIn, checkOut); // You might need to update api.ts to pass args
